...
public final class OperatorAlertKafkaHeaderConsumerInterceptor
	implements ConsumerInterceptor<String, String> {

	public static final String PRIMARY_TOPIC_CONFIG =
		"airbob.operator-alert.kafka.primary-topic";
	...
	public ConsumerRecords<String, String> onConsume(ConsumerRecords<String, String> records) {
		for (var record : records) {
			if (record.topic().equals(primaryTopic)) {
				OperatorAlertKafkaHeaders.stripFrameworkOwned(record.headers());
			}
		}
		return records;
	}
