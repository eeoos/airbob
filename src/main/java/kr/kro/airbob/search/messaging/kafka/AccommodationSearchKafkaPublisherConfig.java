...
public class AccommodationSearchKafkaPublisherConfig {
	...
	private static final class SanitizingInterceptor
		...
		public ProducerRecord<String, String> onSend(ProducerRecord<String, String> record) {
			...
			Headers sanitizedHeaders = AccommodationSearchKafkaHeaders
				.copyValidatedFrameworkOwned(
		...
		private SanitizedPayload sanitize(String value) {
			try {
				EventEnvelope<AccommodationSearchRefreshRequestedV1> envelope = codec.decode(
					value,
