...
class DailyRevenueStatsIntegrationTest {
	...
	void statsEqualsRaw() {
		...
		List<RevenueStatsResponse.DailyRevenue> stats =
			revenueStatsService.getDailyRevenue(D1, D2, RevenueStatsService.SOURCE_STATS).items();
		List<RevenueStatsResponse.DailyRevenue> raw =
			revenueStatsService.getDailyRevenue(D1, D2, RevenueStatsService.SOURCE_RAW).items();
