...
locals {
  private_dns_records = local.services_enabled && !var.global_b_import_from_mac && !(var.global_b_snapshot_restore_only && var.global_b_snapshot_source_mode == "mac-snapshot-counts-ddl") ? ((var.global_b_prepare_only || var.global_b_snapshot_restore_only) ? {
