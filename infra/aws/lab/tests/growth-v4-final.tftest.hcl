...
variables {
  ...
  dataset_release            = "korea-growth-v4-778895bd2bd73be4-aws-r1"
  dataset_manifest_sha256    = filesha256("tests/fixtures/growth-v4-final-aws-manifest.json")
...
override_data {
  ...
  override_during = plan
  values = {
    body = file("tests/fixtures/growth-v4-final-aws-manifest.json")
  }
}
