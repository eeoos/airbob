...
function parseBenchmarkDatasetManifest(raw) {
  let manifest;
  try {
...
function findExperimentCapsule(manifest, capsuleId) {
...
function findCapsuleTarget(capsule, targetId) {
...
function requireAccountCapacity(capsule, requiredCapacity) {
